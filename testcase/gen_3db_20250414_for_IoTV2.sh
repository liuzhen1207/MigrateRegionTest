...
function run_bm()
{
  ...
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/conf/gen_3db_bm1.conf
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/conf/gen_3db_bm2.conf
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/conf/gen_3db_bm3.conf
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/conf/gen_3db_bm4.conf
  ${bm_dir}/test.sh gen_3db_bm1.conf > ${bm_dir}/${out_file}_1.out
  ${bm_dir}/test.sh gen_3db_bm2.conf > ${bm_dir}/${out_file}_2.out
  ${bm_dir}/test.sh gen_3db_bm3.conf > ${bm_dir}/${out_file}_3.out
  ${bm_dir}/test.sh gen_3db_bm4.conf > ${bm_dir}/${out_file}_4.out
