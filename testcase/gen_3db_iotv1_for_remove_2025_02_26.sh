...
function run_bm()
{
  ...
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/gen_3db_remove/conf1 > ${bm_dir}/${out_file}_1.out
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/gen_3db_remove/conf2 > ${bm_dir}/${out_file}_2.out
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/gen_3db_remove/conf3 > ${bm_dir}/${out_file}_3.out
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/gen_3db_remove/conf4 > ${bm_dir}/${out_file}_4.out
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/gen_3db_remove/conf5_tab > ${bm_dir}/${out_file}_5.out
