...
function run_bm()
{
  ...
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/tc7/conf1/config.properties
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/tc7/conf2/config.properties
  sed -i "s/^HOST=.*/HOST=${iotdb_host}/g" ${bm_dir}/tc7/conf3/config.properties
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/tc7/conf1 > ${bm_dir}/${out_file}_1.out
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/tc7/conf2 > ${bm_dir}/${out_file}_2.out
  ${bm_dir}/benchmark.sh -cf ${bm_dir}/tc7/conf3 > ${bm_dir}/${out_file}_3.out
