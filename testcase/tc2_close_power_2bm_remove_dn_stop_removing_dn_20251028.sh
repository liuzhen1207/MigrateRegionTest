...
set_sys_conf ${line} ${db_dir} ".*enable_separation_of_powers=.*" "enable_separation_of_powers=false"
  done
...
#start 2bm
   ...
   nohup sh -x ${bm_dir}/benchmark.sh -cf ${bm_dir}/lt_10type_user_no_ssl_root/conf1 >${bm_dir}/${v_t}_tc2_root_bm1.out &
   nohup sh -x ${bm_dir}/benchmark.sh -cf ${bm_dir}/lt_10type_user_no_ssl_root/conf2 >${bm_dir}/${v_t}_tc2_root_bm2.out &
   sleep 30
