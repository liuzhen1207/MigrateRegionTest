...
table_base_workload="conf_tab1_5x"
table_view_workload="conf_tab2_5x"
...
compare_cn_leader_disk_usage_std() {
  ...
  append_warn "cn leader disk usage std did not improve after first load balance: value1=${cn_leader_disk_usage_std_before_first_load_balance}, value2=${cn_leader_disk_usage_std_after_first_load_balance}"
  let fail_flag++
  return 1
}
