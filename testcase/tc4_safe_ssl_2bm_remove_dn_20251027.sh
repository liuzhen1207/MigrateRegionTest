...
#start 2bm
   ...
   sed -i "s/^HOST=.*/HOST=${v_host}/g" ${bm_dir}/lt_10type_user/conf*/config.properties
   nohup sh -x ${bm_dir}/benchmark.sh -cf ${bm_dir}/lt_10type_user/conf1 >${bm_dir}/${v_t}_tc4_bm1.out &
   nohup sh -x ${bm_dir}/benchmark.sh -cf ${bm_dir}/lt_10type_user/conf2 >${bm_dir}/${v_t}_tc4_bm2.out &
   sleep 30
