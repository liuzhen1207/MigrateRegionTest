...
function set_conf()
{
  ...
  do
     ...
     ssh ${u_name}@${line} "sed -i 's/.*data_region_consensus_protocol_class=.*/data_region_consensus_protocol_class=org.apache.iotdb.consensus.iot.IoTV2Consensus/g' ${db_dir}/conf/iotdb-system.properties"
